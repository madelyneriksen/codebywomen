...
const barStyles = "bg-near-black flex items-center justify-center justify-start-ns ph2 ph3-ns z-999";


export default Navbar => (
  <React.Fragment>
    <div className={barStyles + " pv3"}>
      <Link
        className="f2 f1-l fw8 ttu sans-serif no-underline washed-blue tracked-tight"
        to="/">{"{"} Code<span className="fw3"> By </span>Women {"}"}</Link>
    </div>
    <div className={barStyles + " pv4 top-0"} style={{position: "sticky"}}>
